  ...
  return (
    <div className="relative">
      ...
      <input
        id="search"
        type="search"
        className="w-full h-12 pl-11 pr-3 text-black text-base outline-none rounded-lg border focus:border-primary-500 focus:ring-2 focus:ring-primary-500 focus:ring-opacity-30 ring-offset-1 ring-offset-transparent"
        {...props}
      />
    </div>
  );
